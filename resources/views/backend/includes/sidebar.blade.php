...
<img src="{{ asset('/') }}admin/assets/images/brand/logo.png" class="header-brand-img desktop-logo" alt="logo">
                <img src="{{ asset('/') }}admin/assets/images/brand/logo.png" class="header-brand-img toggle-logo" alt="logo">
                <img src="{{ asset('/') }}admin/assets/images/brand/logo.png" class="header-brand-img light-logo" alt="logo">
{{--                <img src="{{ asset('/') }}admin/assets/images/brand/logo-3.png" class="header-brand-img light-logo1" alt="logo">--}}
                <h3 class="header-brand-img desktop-logo text-white">Institute</h3>
{{--                <h3 class="header-brand-img toggle-logo text-white">OTMS</h3>--}}
{{--                <h3 class="header-brand-img light-logo text-black">OTMS</h3>--}}
                <h3 class="header-brand-img light-logo1 text-black">Institute</h3>
            </a><!-- LOGO -->
        </div>
