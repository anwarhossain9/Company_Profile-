...
function ManagementMessage({ceo_name,ceo_image, ceo_word, director_image, director_name,director_word}) {
  ...
  return (
    <div className="grid md:grid-cols-2 gap-6 md:space-x-10  items-center justify-center card shadow-sm py-5 bg-lime-50">
      {/* Card 1 */}
      <div className='mx-auto md:px-4'>
        <div className="flex flex-col sm:flex-row items-start sm:items-end gap-4 mb-4">
          <img className="w-32 sm:w-[150px] rounded" src={ceo_image} alt={ceo_name} />
          <div>
            <h1 className="text-lg sm:text-xl md:text-2xl font-semibold">{ceo_name}</h1>
      ...
      <div className='mx-auto md:px-4'>
        <div className="flex flex-col sm:flex-row items-start sm:items-end gap-4 mb-4">
          ...
          <div>
            <h1 className="text-lg sm:text-xl md:text-2xl font-semibold">{director_name}</h1>
            <h2 className="text-base sm:text-lg">{director_word}</h2>
          </div>
        </div>
        <p className="text-justify text-sm md:text-base">
