...
function AssectProjectDetails() {
  
    const { assectTitle } = useParams()
    ...
    const course = rplData.find(course => course.rpl_subject_name === assectTitle)
...
export default AssectProjectDetails