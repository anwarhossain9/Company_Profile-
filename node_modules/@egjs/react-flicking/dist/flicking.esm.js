...
import VanillaFlicking__default, { getFlickingAttached, ExternalRenderer, VirtualRenderingStrategy, NormalRenderingStrategy, sync, range, EVENTS, getDefaultCameraTransform, getRenderingPanels, withFlickingMethods, CrossFlicking as CrossFlicking$1, SIDE_EVENTS } from '@egjs/flicking';
...
var CROSSFLICKING_DEFAULT_PROPS = __assign(__assign({}, DEFAULT_PROPS), {
  onSideHoldStart: function (e) {},
  onSideHoldEnd: function (e) {},
  onSideMoveStart: function (e) {},
  onSideMove: function (e) {},
  onSideMoveEnd: function (e) {},
  onSideWillChange: function (e) {},
  onSideChanged: function (e) {},
  onSideWillRestore: function (e) {},
  onSideRestored: function (e) {}
});
var CrossFlicking = /*#__PURE__*/function (_super) {
  __extends(CrossFlicking, _super);
  function CrossFlicking(props) {
  ...
  __proto.componentDidMount = function () {
    ...
    var flicking = new CrossFlicking$1(this._viewportElement, __assign(__assign({}, props), {
      externalRenderer: new ReactRenderer(rendererOptions)
    }));
    this._vanillaFlicking = flicking;
    var children = this._getChildren();
  ...
  __proto.render = function () {
    ...
    var _a = this._getClasses(attributes, props),
      viewportClasses = _a.viewportClasses,
      cameraClasses = _a.cameraClasses,
      cameraProps = _a.cameraProps;
  ...
  __proto._bindEvents = function () {
    ...
    Object.keys(SIDE_EVENTS).forEach(function (eventKey) {
      var eventName = SIDE_EVENTS[eventKey];
      _this._bindEvent(eventName);
    });
  };
  CrossFlicking.defaultProps = CROSSFLICKING_DEFAULT_PROPS;
  return CrossFlicking;
}(Flicking);

var CrossGroup = React__default.forwardRef(function (_a, ref) {
...
export { CrossFlicking, CrossGroup, ViewportSlot, Flicking as default };
